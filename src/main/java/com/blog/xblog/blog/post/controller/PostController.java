...
public class PostController {
    ...
    @Operation(summary = "Create post", description = "Create a new post as the authenticated user")
    ...
    @Operation(summary = "Update post", description = "Update a post (author only)")
    @SecurityRequirement(name = "bearerAuth")
    @PutMapping("/{id}")
